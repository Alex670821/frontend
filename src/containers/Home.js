      ...
      <div className="container">
        <div className="row justify-content-md-center">
          <div className="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
            <h2 className="fs-6 text-secondary mb-2 text-uppercase text-center">Directos Disponibles</h2>
            <p className="display-5 mb-4 mb-md-5 text-center">Busca y disfruta de los directos en tiempo real.</p>
